...
function (_PureComponent) {
  ...
  _createClass(FormImageUpload, [{
    ...
    value: function render() {
      ...
      return _react.default.createElement(_react.default.Fragment, null, isHaveInput === true ? _react.default.createElement(_antd.Input, {
        disabled: disabled,
        placeholder: Message,
        value: value,
        onChange: this.change
      }) : '', _react.default.createElement(_antd.Upload, _extends({
        listType: "picture-card"
      }, this.upLoadProps()), this.showView()));
    }
  }]);
