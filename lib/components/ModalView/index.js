...
var _FormSelectMultiple = _interopRequireDefault(require("../FormItems/FormSelectMultiple"));
    ...
    _defineProperty(_assertThisInitialized(_this), "form", function () {
      ...
      return data.map(function (value) {
        var label = value.label,
            ...
            cascaderSelectedOptions = value.cascaderSelectedOptions;
        ...
        switch (type) {
          ...
          case 'selectMultiple':
            ShowType = _FormSelectMultiple.default;
            break;
...
ModalView.propTypes = {
  ...
  cascaderOption: _propTypes.default.array,
  // 联级选择器的下拉框
  cascaderSelectedOptions: _propTypes.default.bool // 联级选择返回SelectedOptions而不是[ID]
